...
#####################################################################################
## For any input .pdb file, the program will extract loop area of this protein, 
## calculate the related information, and storge in an excel file
##
## Utilizing pyrosetta loop selector funciton
#####################################################################################
...
## 利用上一步提取到的index，提取linker sequence, 存入linker_sequence
linker_seqeunce=[]
current_sequence=''
n=0
for sequence in linker_sequence_number:
    ...
    linker_seqeunce.append(current_sequence)
